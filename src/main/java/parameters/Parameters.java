...
public final class Parameters {
    public static final long SEED = 2104;
    public static final int WIDTH = 1000;
    public static final int HEIGHT = 1000;
    public static final float NOISE_SCALE = 2.5f;
    public static final float NOISE_ZOOM = 1.75f;
    public static final int NUMBER_OF_POINTS = 5000000;
    public static final Color BACKGROUND_COLOR = new Color(255, 255, 242);
    public static final Color STROKE_COLOR = new Color(16, 8, 16, 12.75f);
